...
The best way to learn how to develop a Mule application that is ready for CloudHub is to read the link:/runtime-manager/cloudhub[CloudHub] guide, which includes walkthroughs of basic concepts and examples to help get you familiar with the process of developing and deploying your applications in CloudHub. 
