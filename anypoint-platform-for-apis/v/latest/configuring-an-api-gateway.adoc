...
Refer to the link:/mule-user-guide/v/3.6[Mule User Guide] or the link:/runtime-manager[CloudHub Documentation] for reference information about using your API Gateway, keeping in mind the previously described usage restrictions.
