...
This document assumes that you are familiar with link:/runtime-manager/deploying-a-cloudHub-application[deploying applications using the CloudHub console] and that you are deploying to runtime 3.4.n, 3.5.n, or newer. 
