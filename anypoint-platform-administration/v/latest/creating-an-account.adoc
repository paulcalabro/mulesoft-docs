...
Before you can start using link:/runtime-manager/[CloudHub] or the link:/anypoint-platform-for-apis[Anypoint Platform for APIs], you need to create an *Anypoint Platform* account.
