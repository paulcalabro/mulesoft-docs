...
For more about creating and deploying integration applications, see link:/runtime-manager/getting-started-with-cloudhub[Getting Started with CloudHub] and link:/runtime-manager/deploying-a-cloudhub-application[Deploying a CloudHub Application].
