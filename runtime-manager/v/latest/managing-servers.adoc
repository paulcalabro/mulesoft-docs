...
If you select any of the servers, server groups or clusters on the Servers tab, a pannel opens on the right. Here you will be able to read additional information about it and access some configuration items.
