...
Similarly, the Runtime Manager On-Premise Edition offers a reduced version of the Anypoint Platform, that only comprises the link:/runtime-manager[Runtume Manager] functionality that allows you to deploy applications to your own servers.
