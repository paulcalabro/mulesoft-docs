...
* New link:/runtime-manager/deploying-a-cloudhub-application[worker sizing] capabilities for accounts that have link:/runtime-manager/cloudhub-fabric[CloudHub Fabric] enabled.
...
* Support for link:/runtime-manager/deploying-a-cloudhub-application[global deployment] 
* Mule 3.4 support

== R27 - March 16, 2013

* Improved Insight dashboard with new link:/runtime-manager/cloudhub-insight[Events Filter]
