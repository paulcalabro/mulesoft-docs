...
The Runtime Manager REST API provides a way for you to programmatically access much of the functionality offered by the link:/runtime-manager/cloudhub-and-runtime-manager[Runtime Manager].
