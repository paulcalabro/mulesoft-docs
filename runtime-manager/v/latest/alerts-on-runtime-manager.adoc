...
+
[NOTE]
Different severity levels currently have no effect on alerts, but will in the future when other features are released.
...
. List the recepients of this email. You can select users of the platform, or also freely write email addresses of people who aren't in the organiztion.
. Click *Create Alert*.
...
Depending on what your alert's source is, different event types exist. Below are the event types for servers and for deployments to CloudHub and local servers and for Mule Servers, server groups and clusters.

=== Conditions on CloudHub Applications

On an application that's deployed to CloudHub, you can select any of these alert conditions. Some of these are self explaining notifications of different events such as 'Application Deployment Success', others require that you complete additional parameters that appear as new fields in the form.
...
On an application that's deployed to local servers, you can select any of these alert events. All of these are self explaining events such as 'Application Deployment Success'.
...
If you view the panel of an application or server, you will see a *View Alerts* link. In there you will be able to see and manage the alerts that are sourced from it. You can also click on the *Alerts* link on the left panel to view all alerts together.

image:view-alerts.png[alerts]


From this menu you can filter the displayed alerts, click on an alert name to directly edit it, or click on the icon next to one to open its panel to view its settings. From this panel you can click the *edit* icon next to the name.
...
Select one or several alerts and then, from the alert pannel, simply click the *duplicate* icon. You're then free to edit your new alert at will.
...
Select one or several a alerts and then, from the alert pannel, simply click the *delete* icon.
