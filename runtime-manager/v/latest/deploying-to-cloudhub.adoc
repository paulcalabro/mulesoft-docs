...
* link:/runtime-manager/managing-cloudhub-applications[Managing CloudHub Applications] contains more information on how to manage your applicationw with setting that are specific to CloudHub
